...
with(plotData, {
  plot(Time,Sub_metering_1,ylim=range(c(Sub_metering_1,Sub_metering_2,Sub_metering_3)),type="l")
  plot(Time,Sub_metering_2,ylim=range(c(Sub_metering_1,Sub_metering_2,Sub_metering_3)),type="l")
  plot(Time,Sub_metering_3,ylim=range(c(Sub_metering_1,Sub_metering_2,Sub_metering_3)),type="l",xlab="",ylab="Energy sub metering")
